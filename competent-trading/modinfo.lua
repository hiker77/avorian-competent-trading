...
meta =
{
    ...
    description = "Upgrades the memory on trading computers so they can hold more than a mere handful jumps of history.\nNote: Only 'Exceptional' trading systems and better have available memory slots.",
